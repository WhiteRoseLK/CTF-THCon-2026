...
- **Status** — ✅ solved (flag validated by the platform) · ⚠️ writeup published but flag not validated · ❌ not solved (no writeup)
- **IA** — ✅ writeup generated with AI assistance · ❌ written by hand · — no writeup yet
...
| No Cap Just Root (part 6/8) | 498 | ❌ | — | — |
| No Cap Just Root (part 7/8) | 498 | ❌ | — | — |
| No Cap Just Root (part 8/8) | 498 | ❌ | — | — |
